...
<?php 
    ...
    $sector = $_POST["net_structure"];
    $mobiliser_province = $_POST["province"];
    $survey_numbers = $_POST["number_of_surveys"];

    $header_sector = $sector;
    $header_province = $mobiliser_province;
    $header_survey_numbers = $survey_numbers;
